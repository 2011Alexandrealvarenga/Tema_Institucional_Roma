<?php get_header(); ?>
  ...
  <section class="ambiente">
    <div class="container">
      <div class="row">
        <div class="col">
          <div class="titulo" data-aos="fade-right"><h3 >Confira Alguns Ambientes que nós ja fizemos</h3></div>
          <div class="conteudo">
            <div class="item">
        ...
        <div class="col d-flex justify-content-center">
          <div class="conteudo-todo">
            ...
            <div class="conteudo" data-aos="fade-right">             
              <div class="item-zap">
                <a href="https://api.whatsapp.com/send?phone=5511977773042&text=Ol%C3%A1%20Roma,%20visitei%20o%20seu%20site%20e%20gostaria%20de%20saber%20mais%20informa%C3%A7%C3%B5es." class="float" target="_blank"><i class="icon-whatsapp img-zap"></i></a> 
              </div> 
             </div>
          </div>
         </div>
        ...
        <div class="row content-contato">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6  pt-2">
            <div class="contato-dados">
              ...
              <div class="indique"><h5>Indique e ganhe desconto!</h5></div>
            </div>
          </div>
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 pt-2">
