<?php /* Template name: area-servico */

 ?>
<?php get_header(); ?>
  <section class="banner-index-categoria">
    <div class="container">
      <div class="row d-flex justify-content-center"><h2 class="moveis">Àrea de Serviços</h2></div>
      <div class="row">
            ...
            <div class="carousel-inner">
              ...
              <?php if( $my_query->have_posts()) : while( $my_query->have_posts() ) : $my_query->the_post(); ?>
                <div class="carousel-item <?php $c++; if($c == 1) { echo ' active'; } ?>">
                  <a href="<?php the_permalink(); ?> "><?php the_post_thumbnail('post-thumbnail', array('class' => '')) ?></a>
    ...
    <div class="row">
      <div class="col">
        <div class="conteudo-categoria">
          <h2>Confira algumas Àreas de Serviços que ja fizemos </h2>
          <?php 
            // args
            $my_args = array(
              'post_type' => 'post',          
